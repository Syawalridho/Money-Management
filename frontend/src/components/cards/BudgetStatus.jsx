...
const BudgetStatus = () => (
    <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
        ...
        <ul className="space-y-4">
            <li>
                <p className="flex justify-between text-sm"><span className="font-medium">Makanan & Minuman</span><span>Rp750.000 / Rp1.500.000</span></p>
            ...
            <li>
                <p className="flex justify-between text-sm"><span className="font-medium">Transportasi</span><span>Rp400.000 / Rp500.000</span></p>
            ...
            <li>
                <p className="flex justify-between text-sm"><span className="font-medium">Hiburan</span><span>Rp650.000 / Rp600.000</span></p>
