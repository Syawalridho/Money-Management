...
export default function AddBudgetForm({ onAdd }) {
  ...
  return (
    <div className="mt-8">
      <h2 className="text-xl font-bold mb-4">Tambah Anggaran Baru</h2>
      <div className="bg-gray-800 p-6 rounded-xl border border-gray-700">
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
          ...
          <button type="submit" className="bg-blue-600 px-4 py-2.5 rounded-lg hover:bg-blue-700 h-11 font-semibold">
            Tambah
          </button>
        </form>
      </div>
...
const InputGroup = ({ label, ...props }) => (
  <div className="flex flex-col">
    <label className="text-sm text-gray-400 mb-1.5">{label}</label>
    <input {...props} className="p-2.5 rounded-lg bg-gray-700 border border-gray-600 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 h-11" />
  </div>
);