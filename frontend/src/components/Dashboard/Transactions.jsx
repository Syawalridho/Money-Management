    ...
    return (
        <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
            ...
            <div className="flex items-center justify-between mb-6">
                <h3 className="font-semibold text-gray-800 text-lg">Transaksi Terakhir</h3>
                <a href="transactions" className="font-medium text-blue-600 hover:text-blue-800 text-sm">
                    Lihat Semua
                </a>
            </div>
            ...
            <div className="space-y-2">
                {transactionData.map((tx, index) => (
                    <div key={index} className="grid grid-cols-10 gap-4 p-3 rounded-lg hover:bg-gray-50">
